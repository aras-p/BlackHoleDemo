...
public class AudioSpectrum : MonoBehaviour
{
    ...
    void Update ()
    {
        ...
        Shader.SetGlobalFloatArray("_GlobalAudioSpectrumLevel", levels);
        Shader.SetGlobalFloatArray("_GlobalAudioSpectrumPeak", peakLevels);
        Shader.SetGlobalFloatArray("_GlobalAudioSpectrumMean", meanLevels);
    }
    #endregion
}
